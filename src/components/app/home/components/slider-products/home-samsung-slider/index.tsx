...
function SamsungSlider() {
  ...
  const { data, isPending } = useCategoriesBuySlug("Samsung");
  ...
  return (
    <Slider
      ...
      titleSlider={
        <div className="flex items-center justify-between md:pl-40">
          <h3 className="font-Bold text-lg text-gray-800 ">
            {" "}
            {titleSlider.slider.samsung}
          </h3>
          <Link
            href="/pcat/mobile/samsung"
      ...
      classSwiperSlide="bg-white border border-gray-100  box-border hover:shadow-primary my-2 w-full md:max-w-fit rounded-md  md:min-h-[360px]"
      classMainSlider="  justify-between flex flex-col pr-4 mt-16 md:pr-40"
      ...
      fade={true}
      classNameFade="w-80 h-full top-0 md:z-20 hidden md:block left-0 absolute  md:bg-fade-gradient"
