...
function MyListProducts({ product }: any) {
  ...
  return (
    <Slider
      ...
      classSwiperSlide="bg-white border border-gray-100  p-2  box-border hover:shadow-primary my-2 w-full md:max-w-fit rounded-md"
